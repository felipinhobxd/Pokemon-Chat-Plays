...
function montarConteudoEnv(v, envAtual = '') {
  ...
  const linhas = [
    ...
    '',
    '# ----- SEGURAR (hold) — teclado, mouse e gamepad -----',
    '# Duração padrão dos holds (hold clique, hold pad a, hold cima ...)',
    `HOLD_DEFAULT_MS=${val('HOLD_DEFAULT_MS')}`,
    '# Duração máxima de qualquer hold: 10000 (10s). Mínimo aceito: 1ms',
